...
export const gear: Gear[] = [
  {
    ...
    flies: ["mini-2", "mini-4k", "mini-3", "mini-3-pro", "air-2s"],
    note: "Phone clamp for Mini 2, Mini 4K, Mini 3 family and Air 2S (O3 on that airframe). Does not fly Mini 4 Pro, Mini 5 Pro, Flip or Air 3.",
  ...
  },
  {
    ...
    flies: ["air-2s", "air-3", "mavic-3-classic", "mavic-3-pro"],
    note: "Mavic 3-era screen controllers. DJI lists DJI RC for Air 2S; Air 3 can use them. Not RC 2, not a Mini 5 Pro stick.",
  ...
  },
  {
    ...
    transmission: "—",
    screen: "—",
    flies: ["mini-2", "mini-4k"],
    note: "Mini 2 / Mini 2 SE / Mini 4K family. Same 2250 mAh 17.32 Wh pack.",
  ...
  },
  {
    ...
    protocolNote: "Will not seat in Air 3 or Air 3S.",
