...
export const gear: Gear[] = [
  {
    slug: "rc-mini-se",
    kind: "rc",
    name: "DJI Mini SE remote controller",
    shortName: "Mini SE RC",
    released: "2021-06-11",
    discontinued: true,
    sortOrder: 8,
    form: "Phone clamp",
    ...
    flies: ["mini-se"],
    note: "Wi-Fi Mini SE stick. Not RC-N1. Mini 2 / Mini 4K packs fit the airframe; this radio does not.",
    protocolNote: "Enhanced Wi-Fi. A beautiful RC-N1 does not become a Mini SE stick.",
    djiUrl: "https://www.dji.com/uk/support/product/mini-se",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+Mini+SE+controller",
    sources: [
      src("compat", "DJI Mini SE remote controller notes", "https://www.dji.com/uk/support/product/mini-se"),
    ],
  },
  {
    slug: "rc-n1",
    ...
    transmission: "O2 / O3",
    screen: "None — your phone",
    flies: ["mini-2", "mini-4k", "mini-3", "mini-3-pro", "mavic-air-2", "air-2s", "mavic-3"],
    note: "Phone clamp for Mini 2, Mini 4K, Mini 3 family, Air 2, Air 2S and original Mavic 3. Does not fly Mini SE (Wi-Fi stick), Mini 4 Pro, Mini 5 Pro, Flip or Air 3.",
    ...
    sources: [
      src("compat", "DJI Mini 2 / Mini 3 Pro / Air 2S controller notes", "https://www.dji.com/uk/support/product/air-2s"),
    ],
  },
  {
    slug: "rc-n2",
  ...
  },
  {
    slug: "rc-mavic-2",
    kind: "rc",
    name: "DJI RC (Mavic 2 / OcuSync 2)",
    shortName: "Mavic 2 RC",
    released: "2018-08-23",
    discontinued: true,
    sortOrder: 45,
    form: "Phone clamp",
    ...
    screen: "None — your phone",
    flies: ["mavic-2-pro"],
    note: "Mavic 2-era OcuSync 2 stick / Smart Controller family. Not RC-N1, not the Mavic 3 RC.",
    protocolNote: "OcuSync 2.0. Will not fly Mavic 3 or Air 2S.",
    djiUrl: "https://www.dji.com/uk/support/product/mavic-2",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+Mavic+2+controller",
    sources: [
      src("compat", "DJI Mavic 2 controller notes", "https://www.dji.com/uk/support/product/mavic-2"),
    ],
  },
  {
    slug: "rc-mavic-3",
    ...
    flies: ["air-2s", "air-3", "mavic-3", "mavic-3-classic", "mavic-3-pro"],
    note: "Mavic 3-era screen controllers. DJI lists DJI RC for Air 2S and original Mavic 3; Air 3 can use them. Not RC 2, not a Mini 5 Pro stick.",
    ...
    sources: [
      ...
      src("compat-air-2s", "DJI Air 2S lists DJI RC", "https://www.dji.com/uk/support/product/air-2s"),
    ],
  },
  {
    slug: "motion-2",
  ...
  },
  {
    ...
    screen: "None — goggles",
    flies: ["fpv", "avata"],
    note: "Stick radio for DJI FPV and original Avata. Not FPV RC 3, not Motion 2. Goggles still required.",
    protocolNote: "O3 FPV sticks. Will not fly Avata 2.",
    djiUrl: "https://www.dji.com/uk/support/product/dji-fpv",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+FPV+Remote+Controller+2",
    sources: [
      src("compat", "DJI FPV Remote Controller 2 notes", "https://www.dji.com/uk/support/product/dji-fpv"),
    ],
  },
  {
    slug: "fpv-rc-3",
  ...
  },
  {
    ...
    shortName: "Goggles V2",
    released: "2021-03-02",
    discontinued: true,
    sortOrder: 85,
    form: "Headset",
    transmission: "O3",
    screen: "LCD, four antennas",
    flies: ["fpv", "avata"],
    note: "DJI FPV headset. Avata Fly Smart kits also shipped V2. Not Goggles 2, not Goggles 3.",
    protocolNote: "O3. Will not fly Avata 2 or Neo 2.",
    djiUrl: "https://www.dji.com/uk/support/product/dji-fpv",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+FPV+Goggles+V2",
    sources: [
      src("compat", "DJI FPV Goggles V2 notes", "https://www.dji.com/uk/support/product/dji-fpv"),
      src("compat-avata", "Heliguy: Avata Fly Smart is FPV Goggles V2", "https://www.heliguy.com/blogs/posts/dji-avata-which-combo-is-best/"),
    ],
  },
  {
    slug: "goggles-2",
  ...
  },
  {
    ...
    transmission: "—",
    screen: "—",
    flies: ["mini-se", "mini-2", "mini-4k"],
    note: "Mini SE / Mini 2 / Mini 2 SE / Mini 4K family. Same 2250 mAh 17.32 Wh pack.",
    ...
    sources: [
      src("compat", "DJI Mini 2 / Mini 4K battery notes", "https://www.dji.com/uk/support/product/mini-2"),
    ],
  },
  {
  ...
  {
    slug: "batt-mavic-air-2",
    kind: "battery",
    name: "Mavic Air 2 Intelligent Flight Battery",
    shortName: "Air 2 pack",
    released: "2020-04-27",
    discontinued: true,
    sortOrder: 262,
    form: "Intelligent Flight Battery",
    ...
    screen: "—",
    flies: ["mavic-air-2"],
    note: "3500 mAh / 40.42 Wh. Same watt-hour number as one Air 2S pack version — will not seat in Air 2S.",
    protocolNote: "Will not seat in Air 2S, Air 3 or Air 3S.",
    djiUrl: "https://store.dji.com/uk/product/mavic-air-2",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+Mavic+Air+2+battery",
    sources: [src("compat", "DJI Mavic Air 2 battery notes", "https://www.dji.com/uk/support/product/mavic-air-2")],
  },
  {
    slug: "batt-air-2s",
    kind: "battery",
    name: "Air 2S Intelligent Flight Battery",
    shortName: "Air 2S pack",
    released: "2021-04-15",
    discontinued: true,
    sortOrder: 265,
    form: "Intelligent Flight Battery",
    ...
    screen: "—",
    flies: ["air-2s"],
    note: "Two published versions: 3500 mAh / 40.42 Wh and 3750 mAh / 41.4 Wh. Not an Air 3 pack.",
    protocolNote: "Will not seat in Air 2, Air 3 or Air 3S.",
    djiUrl: "https://store.dji.com/uk/product/dji-air-2s",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+Air+2S+battery",
    sources: [src("compat", "DJI Air 2S battery notes", "https://www.dji.com/uk/support/product/air-2s")],
  },
  {
    slug: "batt-air-3",
    kind: "battery",
  ...
  },
  {
    slug: "batt-mavic-2",
    kind: "battery",
    name: "Mavic 2 Intelligent Flight Battery",
    shortName: "Mavic 2 pack",
    released: "2018-08-23",
    discontinued: true,
    sortOrder: 275,
    form: "Intelligent Flight Battery",
    ...
    screen: "—",
    flies: ["mavic-2-pro"],
    note: "3850 mAh / 59.29 Wh. Not a Mavic 3 pack.",
    protocolNote: "Will not seat in Mavic 3, Classic or Pro.",
    djiUrl: "https://store.dji.com/uk/product/mavic-2",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+Mavic+2+battery",
    sources: [src("compat", "DJI Mavic 2 battery notes", "https://www.dji.com/uk/support/product/mavic-2")],
  },
  {
    slug: "batt-mavic-3",
    kind: "battery",
    ...
    transmission: "—",
    screen: "—",
    flies: ["mavic-3", "mavic-3-classic", "mavic-3-pro"],
    note: "Original Mavic 3, Classic and Pro share the Mavic 3 pack. Not Mavic 2, not Mavic 4 Pro.",
  ...
  },
  {
    ...
    screen: "—",
    flies: ["fpv"],
    note: "2000 mAh 22.2 V 44.4 Wh. Not an Avata pack.",
    protocolNote: "Will not seat in Avata 1 or Avata 2.",
    djiUrl: "https://store.dji.com/uk/product/dji-fpv",
    djiRrpGbp: null,
    amazonUrl: "https://www.amazon.co.uk/s?k=DJI+FPV+battery",
    sources: [src("compat", "DJI FPV battery notes", "https://www.dji.com/uk/support/product/dji-fpv")],
  },
  {
    slug: "batt-avata",
    kind: "battery",
