...
export const parts: Part[] = [
  ...
  },
  {
    id: "rc-n2",
    kind: "rc",
    name: "DJI RC-N2 / RC-N3 (phone holder)",
    drones: [
      "mini-3",
      "mini-3-pro",
      "mini-4k",
    ...
    note: "Phone-clamp controllers. Protocol still has to match the airframe (O3 vs O4). Do not assume a Mini 3 RC-N1 flies a Mini 5 Pro.",
  },
  {
    id: "rc-2",
    kind: "rc",
