...
export const glossary: Record<string, GlossaryEntry> = {
  ...
  ukClass: {
    ...
    body: "C0 is under 250 g. C1 is under 900 g. C2 is the next step up and changes where you may fly near people. DJI now prints class marks; some older airframes are unmarked and use the CAA legacy weight table (under 250 g → A1; under 2 kg → A2 with CofC, else A3). Fitting a heavier ‘Plus’ battery can move a Mini out of C0. The mark on the aircraft you take off with is the one that counts.",
  ...
  ukOpen: {
    ...
    body: "The UK Open category (March 2026 code) splits into A1, A2 and A3. C0 and, until 31 December 2027, C1 fly in A1. C2 needs an A2 Certificate of Competence to use A2 distances; otherwise it is A3. Legacy aircraft with no UK or EU class mark use the CAA weight table: under 250 g is A1; under 2 kg is A2 with a CofC, otherwise A3. This is not a DJI marketing tier.",
  ...
  flies: {
    ...
    oneLiner: "Which of our 23 DJI airframes this stick, motion or headset is listed for.",
